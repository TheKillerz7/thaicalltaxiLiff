...
const RoomsPage = ({ userId, userType }) => {
    ...
    useEffect(() => {
        let rooms = []
        const socket = io("https://7821-2405-9800-b650-586-8470-6a3b-d34-5206.ap.ngrok.io", connectionOptions)
...
const ChatPage = ({ roomId, userType, userId }) => {
    ...
    useEffect(() => {
        socket = io("https://7821-2405-9800-b650-586-8470-6a3b-d34-5206.ap.ngrok.io", connectionOptions)
        let messageStorage = []
